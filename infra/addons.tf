...
module "eks_addons" {
  ...
  # Cluster information
  cluster_name      = module.game_eks.cluster_name
  cluster_endpoint  = module.game_eks.cluster_endpoint
  cluster_version   = module.game_eks.cluster_version
  oidc_provider_arn = module.game_eks.oidc_provider_arn
